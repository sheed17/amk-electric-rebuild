...
const FinalCTA = ({
  ...
  subtitle = "Whether you need a quick repair or a full electrical project, AMK Electric is here to help. Call us or request a quote — we'll get back to you promptly.",
}: FinalCTAProps) => (
